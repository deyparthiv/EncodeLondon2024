...
function sendAsset(recipientPrivateKey, assetToken) {
    return __awaiter(this, void 0, void 0, function () {
        var receivingKeys, transaction;
        return __generator(this, function (_a) {
            receivingKeys = StellarSdk.Keypair.fromSecret("SDGCT6GL3F46RPD2JP4PRG3J56FRTSSGZDD4DNFT3YAG53FMO4XIXWLY");
            ...
            server //establish trust between accounts
                ...
                .then(console.log);
            server.loadAccount(receivingKeys.publicKey()).catch(function (error) {
